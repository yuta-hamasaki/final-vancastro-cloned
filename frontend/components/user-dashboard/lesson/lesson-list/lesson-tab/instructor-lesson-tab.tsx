...
import InstructorLessonList from "../instructor-lesson-list";

type Props = {
  lessons: LessonType[] | undefined;
};

export default function InstructorLessonTab({ lessons }: Props) {
    ...
    <>
      <Tabs defaultValue="today" className="w-full">
        ...
        <TabsContent value="today">
          <InstructorLessonList lessons={filteredLessons} />
        </TabsContent>
        <TabsContent value="all" className="w-full">
          <InstructorLessonList lessons={lessons} />
        </TabsContent>
      </Tabs>
    </>
  );
